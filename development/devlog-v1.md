...
- compiled vim, staged vundle + custom vimrc <br>
  
- installed zsh, oh my zsh, powerlevel10k & jetbrains mono nerd font <br>
  
- staged build‑essentials, rust via rustup <br>
  
- installed btop on am1i + cm4 <br>
  
- installed mark text for blogging/dev logs <br>
